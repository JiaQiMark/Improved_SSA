...
search_range_list = [[0, 0],
                     ...
                     [-100, 100],                                       [-10, 10],   [-1.28, 1.28],
                     [-100, 100],   [-100, 100], [-2.048, 2.048],   [-5.12, 5.12],
                     [-32, 32],     [-600, 600],       [-10, 10],
                                        [0, 14],
                     [-10, 10],     [-512, 512],       [-10, 10],                        [-10, 10]]


common_d = 500
dimension_list = [0,
                  common_d,             common_d,       common_d,         common_d,        common_d,
                  common_d,                                               common_d,        common_d,
                  common_d,             common_d,       common_d,         common_d,
                  common_d,             common_d,       common_d,
                                               2,
                  4,                           2,               2,                                2]
